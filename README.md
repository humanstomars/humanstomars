...
/*
  The Mars Society Donation address:
    0x2d73600cE1A1f2e3Da7e2A47AA23Be076B0bCcA6
    
  The Musk Foundation Donation address:
    0x27453fFCB2a2c1302D26327B79e7B3aD5C2f02B6  
*/
...
contract HumansToMars is IERC20, Ownable {
    ...
    string private _name = "Humans To Mars";
    string private _symbol = "HUMARS";
    ...
    address payable public charityAddress1 =
        payable(address(0x2d73600cE1A1f2e3Da7e2A47AA23Be076B0bCcA6)); // The Mars Society Donation address
    address payable public charityAddress2 =
        payable(address(0x27453fFCB2a2c1302D26327B79e7B3aD5C2f02B6)); // The Musk Foundation Donation address:
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tDonationTotal = _tDonationTotal.add(
            beforeTransferBalance.sub(afterTransferBalance)
        );
    ...
    function setDonationAddress1(address payable charity1)
        external
        onlyOwner
    {
    ...
    function setDonationAddress2(address payable charity2)
        external
        onlyOwner
    {
    ...
    function TransferCharityBNB(address payable recipient, uint256 amount)
        private
    {
